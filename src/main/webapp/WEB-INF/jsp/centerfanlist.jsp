...
<body>
 ...
 <nav class="navbar navbar-default">
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-color: orange;">
  ...
  <div class="container">
     <h1>粉丝列表</h1>  
        ...
        <!-- Pager -->
 <c:forEach items="${fanlist }" var="list" varStatus="i">
			<div class="row">
				<div class="col-md-10"><h3><a href="<%=path%>/center/tocenter?userid2=${list.userid1}">${i.index+1}.${list.username }</a></h3>
				...
				<div class="col-md-2"><button type="button" style="width:100px;height:50px" class="btn btn-success btn-sub" id="sub" name=${list.userid1 }>${subinfo[i.index] }</button></div>
			</div>
			<hr>
		</c:forEach>      
      </div>
