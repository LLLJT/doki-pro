...
<nav class="navbar navbar-default">
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-color:#FF0000">
     ...
     <div class="col-md-8 mx-auto">
      <c:forEach items="${collectlist}" var="list">
        <div class="post-preview">
          <a href="<%=path %>/blog/detail?blogid=${list.blogid }">
            <h2 class="post-title">
              ${list.blogtitle }
            </h2></a>
            ...
            <img src="<%=path %>/${list.pic }" width="100px" height="100px" name="image"  class="img-rounded img_btn">
            </c:if>
